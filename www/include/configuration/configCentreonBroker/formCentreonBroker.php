 ...
 * Form begin
 */
$form = new HTML_QuickForm2('Form', 'post', "?p=".$p, '', array('onsubmit' => 'return formValidate()'));
if ($o == "a") {
...
$timestamp = array();
$timestamp[] = HTML_QuickForm2::createElement('radio', 'write_timestamp', null, _("Yes"), 1);
$timestamp[] = HTML_QuickForm2::createElement('radio', 'write_timestamp', null, _("No"), 0);
$form->addGroup($timestamp, 'write_timestamp', _("Write timestamp"), '&nbsp;');

$thread_id = array();
$thread_id[] = HTML_QuickForm2::createElement('radio', 'write_thread_id', null, _("Yes"), 1);
$thread_id[] = HTML_QuickForm2::createElement('radio', 'write_thread_id', null, _("No"), 0);
$form->addGroup($thread_id, 'write_thread_id', _("Write thread id"), '&nbsp;');
    
$status = array();
$status[] = HTML_QuickForm2::createElement('radio', 'activate', null, _("Enabled"), 1);
$status[] = HTML_QuickForm2::createElement('radio', 'activate', null, _("Disabled"), 0);
$form->addGroup($status, 'activate', _("Status"), '&nbsp;');

$centreonbroker = array();
$centreonbroker[] = HTML_QuickForm2::createElement('radio', 'activate_watchdog', null, _("Yes"), 1);
$centreonbroker[] = HTML_QuickForm2::createElement('radio', 'activate_watchdog', null, _("No"), 0);
$form->addGroup($centreonbroker, 'activate_watchdog', _("Link to cbd service"), '&nbsp;');

$stats_activate = array();
$stats_activate[] = HTML_QuickForm2::createElement('radio', 'stats_activate', null, _("Yes"), 1);
$stats_activate[] = HTML_QuickForm2::createElement('radio', 'stats_activate', null, _("No"), 0);
