...
$serviceIV[] = HTML_QuickForm2::createElement('radio', 'service_is_volatile', null, _("Yes"), '1');
$serviceIV[] = HTML_QuickForm2::createElement('radio', 'service_is_volatile', null, _("No"), '0');
$serviceIV[] = HTML_QuickForm2::createElement('radio', 'service_is_volatile', null, _("Default"), '2');
...
$serviceEHE[] = HTML_QuickForm2::createElement('radio', 'service_event_handler_enabled', null, _("Yes"), '1');
$serviceEHE[] = HTML_QuickForm2::createElement('radio', 'service_event_handler_enabled', null, _("No"), '0');
$serviceEHE[] = HTML_QuickForm2::createElement('radio', 'service_event_handler_enabled', null, _("Default"), '2');
...
$serviceACE[] = HTML_QuickForm2::createElement('radio', 'service_active_checks_enabled', null, _("Yes"), '1');
$serviceACE[] = HTML_QuickForm2::createElement('radio', 'service_active_checks_enabled', null, _("No"), '0');
$serviceACE[] = HTML_QuickForm2::createElement('radio', 'service_active_checks_enabled', null, _("Default"), '2');
...
$servicePCE[] = HTML_QuickForm2::createElement('radio', 'service_passive_checks_enabled', null, _("Yes"), '1');
$servicePCE[] = HTML_QuickForm2::createElement('radio', 'service_passive_checks_enabled', null, _("No"), '0');
$servicePCE[] = HTML_QuickForm2::createElement('radio', 'service_passive_checks_enabled', null, _("Default"), '2');
...
$serviceNE[] = HTML_QuickForm2::createElement('radio', 'service_notifications_enabled', null, _("Yes"), '1');
$serviceNE[] = HTML_QuickForm2::createElement('radio', 'service_notifications_enabled', null, _("No"), '0');
$serviceNE[] = HTML_QuickForm2::createElement('radio', 'service_notifications_enabled', null, _("Default"), '2');
...
if ($o == "mc") {
    $mc_mod_cgs = array();
    $mc_mod_cgs[] = HTML_QuickForm2::createElement('radio', 'mc_mod_cgs', null, _("Incremental"), '0');
    $mc_mod_cgs[] = HTML_QuickForm2::createElement('radio', 'mc_mod_cgs', null, _("Replacement"), '1');
 ...
 */
if ($o == "mc") {
    $contactAdditive[] = HTML_QuickForm2::createElement('radio', 'mc_contact_additive_inheritance', null, _("Yes"), '1');
    $contactAdditive[] = HTML_QuickForm2::createElement('radio', 'mc_contact_additive_inheritance', null, _("No"), '0');
    $contactAdditive[] = HTML_QuickForm2::createElement(
        'radio',
    ...
    $contactGroupAdditive[] = HTML_QuickForm2::createElement('radio', 'mc_cg_additive_inheritance', null, _("Yes"), '1');
    $contactGroupAdditive[] = HTML_QuickForm2::createElement('radio', 'mc_cg_additive_inheritance', null, _("No"), '0');
    $contactGroupAdditive[] = HTML_QuickForm2::createElement(
        'radio',
...
if ($o == "mc") {
    ...
    $mc_mod_notifopt_first_notification_delay[] = &HTML_QuickForm2::createElement(
        'radio',
...
if ($o == "mc") {
    ...
    $mc_mod_notifopt_notification_interval[] = &HTML_QuickForm2::createElement(
        'radio',
...
if ($o == "mc") {
    ...
    $mc_mod_notifopt_timeperiod[] = &HTML_QuickForm2::createElement(
        'radio',
...
if ($o == "mc") {
    ...
    $mc_mod_notifopts[] = &HTML_QuickForm2::createElement('radio', 'mc_mod_notifopts', null, _("Incremental"), '0');
    $mc_mod_notifopts[] = &HTML_QuickForm2::createElement('radio', 'mc_mod_notifopts', null, _("Replacement"), '1');
    $form->addGroup($mc_mod_notifopts, 'mc_mod_notifopts', _("Update mode"), '&nbsp;');
    $form->setDefaults(array('mc_mod_notifopts' => '0'));
}

$serviceNotifOpt[] = HTML_QuickForm2::createElement(
    'checkbox',
    'w',
    '&nbsp;',
    _("Warning"),
...
$serviceStalOpt[] = HTML_QuickForm2::createElement('checkbox', 'o', '&nbsp;', _("Ok"));
$serviceStalOpt[] = HTML_QuickForm2::createElement('checkbox', 'w', '&nbsp;', _("Warning"));
$serviceStalOpt[] = HTML_QuickForm2::createElement('checkbox', 'u', '&nbsp;', _("Unknown"));
$serviceStalOpt[] = HTML_QuickForm2::createElement('checkbox', 'c', '&nbsp;', _("Critical"));
...
$serviceActivation[] = HTML_QuickForm2::createElement('radio', 'service_activate', null, _("Enabled"), '1');
$serviceActivation[] = HTML_QuickForm2::createElement('radio', 'service_activate', null, _("Disabled"), '0');
...
if ($o == "mc") {
    $mc_mod_traps = array();
    $mc_mod_traps[] = HTML_QuickForm2::createElement('radio', 'mc_mod_traps', null, _("Incremental"), '0');
    $mc_mod_traps[] = HTML_QuickForm2::createElement('radio', 'mc_mod_traps', null, _("Replacement"), '1');
...
if ($o == "mc") {
    $mc_mod_Pars = array();
    $mc_mod_Pars[] = HTML_QuickForm2::createElement('radio', 'mc_mod_Pars', null, _("Incremental"), '0');
    $mc_mod_Pars[] = HTML_QuickForm2::createElement('radio', 'mc_mod_Pars', null, _("Replacement"), '1');
...
$servicePC[] = HTML_QuickForm2::createElement('radio', 'service_parallelize_check', null, _("Yes"), '1');
$servicePC[] = HTML_QuickForm2::createElement('radio', 'service_parallelize_check', null, _("No"), '0');
$servicePC[] = HTML_QuickForm2::createElement('radio', 'service_parallelize_check', null, _("Default"), '2');
$form->addGroup($servicePC, 'service_parallelize_check', _("Parallel Check"), '&nbsp;');
if ($o != "mc") {
    $form->setDefaults(array('service_parallelize_check' => '2'));
}

$serviceOOS[] = HTML_QuickForm2::createElement('radio', 'service_obsess_over_service', null, _("Yes"), '1');
$serviceOOS[] = HTML_QuickForm2::createElement('radio', 'service_obsess_over_service', null, _("No"), '0');
$serviceOOS[] = HTML_QuickForm2::createElement('radio', 'service_obsess_over_service', null, _("Default"), '2');
...
$serviceCF[] = HTML_QuickForm2::createElement('radio', 'service_check_freshness', null, _("Yes"), '1');
$serviceCF[] = HTML_QuickForm2::createElement('radio', 'service_check_freshness', null, _("No"), '0');
$serviceCF[] = HTML_QuickForm2::createElement('radio', 'service_check_freshness', null, _("Default"), '2');
$form->addGroup($serviceCF, 'service_check_freshness', _("Check Freshness"), '&nbsp;');
if ($o != "mc") {
    $form->setDefaults(array('service_check_freshness' => '2'));
}

$serviceFDE[] = HTML_QuickForm2::createElement('radio', 'service_flap_detection_enabled', null, _("Yes"), '1');
$serviceFDE[] = HTML_QuickForm2::createElement('radio', 'service_flap_detection_enabled', null, _("No"), '0');
$serviceFDE[] = HTML_QuickForm2::createElement('radio', 'service_flap_detection_enabled', null, _("Default"), '2');
...
$servicePPD[] = HTML_QuickForm2::createElement('radio', 'service_process_perf_data', null, _("Yes"), '1');
$servicePPD[] = HTML_QuickForm2::createElement('radio', 'service_process_perf_data', null, _("No"), '0');
$servicePPD[] = HTML_QuickForm2::createElement('radio', 'service_process_perf_data', null, _("Default"), '2');
$form->addGroup($servicePPD, 'service_process_perf_data', _("Process Perf Data"), '&nbsp;');
if ($o != "mc") {
    $form->setDefaults(array('service_process_perf_data' => '2'));
}

$serviceRSI[] = HTML_QuickForm2::createElement('radio', 'service_retain_status_information', null, _("Yes"), '1');
$serviceRSI[] = HTML_QuickForm2::createElement('radio', 'service_retain_status_information', null, _("No"), '0');
$serviceRSI[] = HTML_QuickForm2::createElement('radio', 'service_retain_status_information', null, _("Default"), '2');
...
$serviceRNI[] = HTML_QuickForm2::createElement('radio', 'service_retain_nonstatus_information', null, _("Yes"), '1');
$serviceRNI[] = HTML_QuickForm2::createElement('radio', 'service_retain_nonstatus_information', null, _("No"), '0');
$serviceRNI[] = HTML_QuickForm2::createElement('radio', 'service_retain_nonstatus_information', null, _("Default"), '2');
...
if ($o == "mc") {
    $mc_mod_sc = array();
    $mc_mod_sc[] = HTML_QuickForm2::createElement('radio', 'mc_mod_sc', null, _("Incremental"), '0');
    $mc_mod_sc[] = HTML_QuickForm2::createElement('radio', 'mc_mod_sc', null, _("Replacement"), '1');
