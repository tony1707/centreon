...
if ($o == "mc") {
    $mc_mod_tplp = array();
    $mc_mod_tplp[] = HTML_QuickForm2::createElement('radio', 'mc_mod_tplp', null, _("Incremental"), '0');
    $mc_mod_tplp[] = HTML_QuickForm2::createElement('radio', 'mc_mod_tplp', null, _("Replacement"), '1');
...
$dupSvTpl[] = HTML_QuickForm2::createElement('radio', 'dupSvTplAssoc', null, _("Yes"), '1');
$dupSvTpl[] = HTML_QuickForm2::createElement('radio', 'dupSvTplAssoc', null, _("No"), '0');
...
$hostEHE[] = HTML_QuickForm2::createElement('radio', 'host_event_handler_enabled', null, _("Yes"), '1');
$hostEHE[] = HTML_QuickForm2::createElement('radio', 'host_event_handler_enabled', null, _("No"), '0');
$hostEHE[] = HTML_QuickForm2::createElement('radio', 'host_event_handler_enabled', null, _("Default"), '2');
...
$hostACE[] = HTML_QuickForm2::createElement('radio', 'host_active_checks_enabled', null, _("Yes"), '1');
$hostACE[] = HTML_QuickForm2::createElement('radio', 'host_active_checks_enabled', null, _("No"), '0');
$hostACE[] = HTML_QuickForm2::createElement('radio', 'host_active_checks_enabled', null, _("Default"), '2');
...
$hostPCE[] = HTML_QuickForm2::createElement('radio', 'host_passive_checks_enabled', null, _("Yes"), '1');
$hostPCE[] = HTML_QuickForm2::createElement('radio', 'host_passive_checks_enabled', null, _("No"), '0');
$hostPCE[] = HTML_QuickForm2::createElement('radio', 'host_passive_checks_enabled', null, _("Default"), '2');
...
$hostNE[] = HTML_QuickForm2::createElement('radio', 'host_notifications_enabled', null, _("Yes"), '1');
$hostNE[] = HTML_QuickForm2::createElement('radio', 'host_notifications_enabled', null, _("No"), '0');
$hostNE[] = HTML_QuickForm2::createElement('radio', 'host_notifications_enabled', null, _("Default"), '2');
...
if ($o == "mc") {
    $mc_mod_hcg = array();
    $mc_mod_hcg[] = HTML_QuickForm2::createElement('radio', 'mc_mod_hcg', null, _("Incremental"), '0');
    $mc_mod_hcg[] = HTML_QuickForm2::createElement('radio', 'mc_mod_hcg', null, _("Replacement"), '1');
...
$hostNotifOpt[] = HTML_QuickForm2::createElement(
    'checkbox',
    'd',
    '&nbsp;',
    _("Down"),
...
$hostStalOpt[] = HTML_QuickForm2::createElement('checkbox', 'o', '&nbsp;', _("Up"));
$hostStalOpt[] = HTML_QuickForm2::createElement('checkbox', 'd', '&nbsp;', _("Down"));
$hostStalOpt[] = HTML_QuickForm2::createElement('checkbox', 'u', '&nbsp;', _("Unreachable"));
...
$hostActivation[] = HTML_QuickForm2::createElement('radio', 'host_activate', null, _("Enabled"), '1');
$hostActivation[] = HTML_QuickForm2::createElement('radio', 'host_activate', null, _("Disabled"), '0');
...
if ($o == "mc") {
    $mc_mod_hpar = array();
    $mc_mod_hpar[] = HTML_QuickForm2::createElement('radio', 'mc_mod_hpar', null, _("Incremental"), '0');
    $mc_mod_hpar[] = HTML_QuickForm2::createElement('radio', 'mc_mod_hpar', null, _("Replacement"), '1');
...
if ($o == "mc") {
    $mc_mod_hch = array();
    $mc_mod_hch[] = HTML_QuickForm2::createElement('radio', 'mc_mod_hch', null, _("Incremental"), '0');
    $mc_mod_hch[] = HTML_QuickForm2::createElement('radio', 'mc_mod_hch', null, _("Replacement"), '1');
...
if ($o == "mc") {
    $mc_mod_hhg = array();
    $mc_mod_hhg[] = HTML_QuickForm2::createElement('radio', 'mc_mod_hhg', null, _("Incremental"), '0');
    $mc_mod_hhg[] = HTML_QuickForm2::createElement('radio', 'mc_mod_hhg', null, _("Replacement"), '1');
...
if ($o == "mc") {
    $mc_mod_hhc = array();
    $mc_mod_hhc[] = HTML_QuickForm2::createElement('radio', 'mc_mod_hhc', null, _("Incremental"), '0');
    $mc_mod_hhc[] = HTML_QuickForm2::createElement('radio', 'mc_mod_hhc', null, _("Replacement"), '1');
...
if ($o == "mc") {
    $mc_mod_nsid = array();
    $mc_mod_nsid[] = HTML_QuickForm2::createElement('radio', 'mc_mod_nsid', null, _("Incremental"), '0');
    $mc_mod_nsid[] = HTML_QuickForm2::createElement('radio', 'mc_mod_nsid', null, _("Replacement"), '1');
...
$hostOOH[] = HTML_QuickForm2::createElement('radio', 'host_obsess_over_host', null, _("Yes"), '1');
$hostOOH[] = HTML_QuickForm2::createElement('radio', 'host_obsess_over_host', null, _("No"), '0');
$hostOOH[] = HTML_QuickForm2::createElement('radio', 'host_obsess_over_host', null, _("Default"), '2');
$form->addGroup($hostOOH, 'host_obsess_over_host', _("Obsess Over Host"), '&nbsp;');
if ($o != "mc") {
    $form->setDefaults(array('host_obsess_over_host' => '2'));
}

$hostCF[] = HTML_QuickForm2::createElement('radio', 'host_check_freshness', null, _("Yes"), '1');
$hostCF[] = HTML_QuickForm2::createElement('radio', 'host_check_freshness', null, _("No"), '0');
$hostCF[] = HTML_QuickForm2::createElement('radio', 'host_check_freshness', null, _("Default"), '2');
$form->addGroup($hostCF, 'host_check_freshness', _("Check Freshness"), '&nbsp;');
if ($o != "mc") {
    $form->setDefaults(array('host_check_freshness' => '2'));
}

$hostFDE[] = HTML_QuickForm2::createElement('radio', 'host_flap_detection_enabled', null, _("Yes"), '1');
$hostFDE[] = HTML_QuickForm2::createElement('radio', 'host_flap_detection_enabled', null, _("No"), '0');
$hostFDE[] = HTML_QuickForm2::createElement('radio', 'host_flap_detection_enabled', null, _("Default"), '2');
...
$hostRSI[] = HTML_QuickForm2::createElement('radio', 'host_retain_status_information', null, _("Yes"), '1');
$hostRSI[] = HTML_QuickForm2::createElement('radio', 'host_retain_status_information', null, _("No"), '0');
$hostRSI[] = HTML_QuickForm2::createElement('radio', 'host_retain_status_information', null, _("Default"), '2');
...
$hostRNI[] = HTML_QuickForm2::createElement('radio', 'host_retain_nonstatus_information', null, _("Yes"), '1');
$hostRNI[] = HTML_QuickForm2::createElement('radio', 'host_retain_nonstatus_information', null, _("No"), '0');
$hostRNI[] = HTML_QuickForm2::createElement('radio', 'host_retain_nonstatus_information', null, _("Default"), '2');
