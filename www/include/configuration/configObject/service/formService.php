...
$serviceIOHC[] = HTML_QuickForm2::createElement('radio', 'service_use_only_contacts_from_host', null, _("Yes"), '1');
$serviceIOHC[] = HTML_QuickForm2::createElement('radio', 'service_use_only_contacts_from_host', null, _("No"), '0');
$form->addGroup(
    $serviceIOHC,
...
if ($o == "mc") {
    $mc_mod_sgs = array();
    $mc_mod_sgs[] = HTML_QuickForm2::createElement('radio', 'mc_mod_sgs', null, _("Incremental"), '0');
    $mc_mod_sgs[] = HTML_QuickForm2::createElement('radio', 'mc_mod_sgs', null, _("Replacement"), '1');
