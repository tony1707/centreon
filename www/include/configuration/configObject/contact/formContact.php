...
if ($o == "mc") {
    $mc_mod_cg = array();
    $mc_mod_cg[] = HTML_QuickForm2::createElement('radio', 'mc_mod_cg', null, _("Incremental"), '0');
    $mc_mod_cg[] = HTML_QuickForm2::createElement('radio', 'mc_mod_cg', null, _("Replacement"), '1');
...
$defaultDatasetRoute = './include/common/webServices/rest/internal.php?object=centreon_configuration_contactgroup'
    . '&action=defaultValues&target=contact&field=contact_cgNotif&id=' . $contact_id;
...
$tab = array();
$tab[] = HTML_QuickForm2::createElement('radio', 'contact_oreon', null, _("Yes"), '1');
$tab[] = HTML_QuickForm2::createElement('radio', 'contact_oreon', null, _("No"), '0');
...
if ($centreon->user->admin) {
    $tab = array();
    $tab[] = HTML_QuickForm2::createElement('radio', 'contact_admin', null, _("Yes"), '1');
    $tab[] = HTML_QuickForm2::createElement('radio', 'contact_admin', null, _("No"), '0');
    $form->addGroup($tab, 'contact_admin', _("Admin"), '&nbsp;');

    $tab = array();
    $tab[] = HTML_QuickForm2::createElement('radio', 'reach_api', null, _("Yes"), '1');
    $tab[] = HTML_QuickForm2::createElement('radio', 'reach_api', null, _("No"), '0');
...
if ($o == "mc") {
    $mc_mod_cg = array();
    $mc_mod_cg[] = HTML_QuickForm2::createElement('radio', 'mc_mod_acl', null, _("Incremental"), '0');
    $mc_mod_cg[] = HTML_QuickForm2::createElement('radio', 'mc_mod_acl', null, _("Replacement"), '1');
...
$defaultDatasetRoute = './include/common/webServices/rest/internal.php?object=centreon_administration_aclgroup'
    . '&action=defaultValues&target=contact&field=contact_acl_groups&id=' . $contact_id;
...
$defaultDatasetRoute = './include/common/webServices/rest/internal.php?object=centreon_configuration_timezone'
    . '&action=defaultValues&target=contact&field=contact_location&id=' . $contact_id;
$attrTimezones = array(
    'datasourceOrigin' => 'ajax',
...
$tab = array();
$tab[] = HTML_QuickForm2::createElement('radio', 'contact_enable_notifications', null, _("Yes"), '1');
$tab[] = HTML_QuickForm2::createElement('radio', 'contact_enable_notifications', null, _("No"), '0');
$tab[] = HTML_QuickForm2::createElement('radio', 'contact_enable_notifications', null, _("Default"), '2');
...
if ($o == "mc") {
    $mc_mod_hcmds = array();
    $mc_mod_hcmds[] = HTML_QuickForm2::createElement('radio', 'mc_mod_hcmds', null, _("Incremental"), '0');
    $mc_mod_hcmds[] = HTML_QuickForm2::createElement('radio', 'mc_mod_hcmds', null, _("Replacement"), '1');
...
$svNotifOpt[] = HTML_QuickForm2::createElement(
    'checkbox',
    'w',
    '&nbsp;',
    _("Warning"),
...
if ($o == "mc") {
    $mc_mod_svcmds = array();
    $mc_mod_svcmds[] = HTML_QuickForm2::createElement('radio', 'mc_mod_svcmds', null, _("Incremental"), '0');
    $mc_mod_svcmds[] = HTML_QuickForm2::createElement('radio', 'mc_mod_svcmds', null, _("Replacement"), '1');
...
$cctActivation[] = HTML_QuickForm2::createElement('radio', 'contact_activate', null, _("Enabled"), '1');
$cctActivation[] = HTML_QuickForm2::createElement('radio', 'contact_activate', null, _("Disabled"), '0');
