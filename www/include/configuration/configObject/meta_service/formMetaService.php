...
$tab = array();
$tab[] = HTML_QuickForm2::createElement('radio', 'meta_select_mode', null, _("Service List"), '1');
$tab[] = HTML_QuickForm2::createElement('radio', 'meta_select_mode', null, _("SQL matching"), '2');
...
$tab = array();
$tab[] = HTML_QuickForm2::createElement('radio', 'notifications_enabled', null, _("Yes"), '1');
$tab[] = HTML_QuickForm2::createElement('radio', 'notifications_enabled', null, _("No"), '0');
$tab[] = HTML_QuickForm2::createElement('radio', 'notifications_enabled', null, _("Default"), '2');
...
$msNotifOpt[] = HTML_QuickForm2::createElement('checkbox', 'w', '&nbsp;', _("Warning"));
$msNotifOpt[] = HTML_QuickForm2::createElement('checkbox', 'u', '&nbsp;', _("Unknown"));
$msNotifOpt[] = HTML_QuickForm2::createElement('checkbox', 'c', '&nbsp;', _("Critical"));
$msNotifOpt[] = HTML_QuickForm2::createElement('checkbox', 'r', '&nbsp;', _("Recovery"));
$msNotifOpt[] = HTML_QuickForm2::createElement('checkbox', 'f', '&nbsp;', _("Flapping"));
...
$msActivation[] = HTML_QuickForm2::createElement('radio', 'meta_activate', null, _("Enabled"), '1');
$msActivation[] = HTML_QuickForm2::createElement('radio', 'meta_activate', null, _("Disabled"), '0');
