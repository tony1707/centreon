...
$tab = array();
$tab[] = HTML_QuickForm2::createElement('radio', 'inherits_parent', null, _("Yes"), '1');
$tab[] = HTML_QuickForm2::createElement('radio', 'inherits_parent', null, _("No"), '0');
$form->addGroup($tab, 'inherits_parent', _("Parent relationship"), '&nbsp;');
$form->setDefaults(array('inherits_parent' => '1'));

$tab = array();
$tab[] = HTML_QuickForm2::createElement(
    'checkbox',
    'o',
    '&nbsp;',
    _("Ok/Up"),
...
$tab = array();
$tab[] = HTML_QuickForm2::createElement('checkbox', 'o', '&nbsp;', _("Ok/Up"));
$tab[] = HTML_QuickForm2::createElement('checkbox', 'd', '&nbsp;', _("Down"));
$tab[] = HTML_QuickForm2::createElement('checkbox', 'u', '&nbsp;', _("Unreachable"));
$tab[] = HTML_QuickForm2::createElement('checkbox', 'p', '&nbsp;', _("Pending"));
$tab[] = HTML_QuickForm2::createElement('checkbox', 'n', '&nbsp;', _("None"));
