...
if ($o == "mc") {
    $mc_mod_htpl = array();
    $mc_mod_htpl[] = HTML_QuickForm2::createElement('radio', 'mc_mod_htpl', null, _("Incremental"), '0');
    $mc_mod_htpl[] = HTML_QuickForm2::createElement('radio', 'mc_mod_htpl', null, _("Replacement"), '1');
...
$hostPPD[] = HTML_QuickForm2::createElement('radio', 'host_process_perf_data', null, _("Yes"), '1');
$hostPPD[] = HTML_QuickForm2::createElement('radio', 'host_process_perf_data', null, _("No"), '0');
$hostPPD[] = HTML_QuickForm2::createElement('radio', 'host_process_perf_data', null, _("Default"), '2');
