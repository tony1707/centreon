 ...
 * Ldap form
 */
$form = new HTML_QuickForm2('Form', 'post', "?p=" . $p . "&o=" . $o);
...
$ldapEnable[] = HTML_QuickForm2::createElement('radio', 'ldap_auth_enable', null, _("Yes"), '1');
$ldapEnable[] = HTML_QuickForm2::createElement('radio', 'ldap_auth_enable', null, _("No"), '0');
$form->addGroup($ldapEnable, 'ldap_auth_enable', _("Enable LDAP authentication"), '&nbsp;');

$ldapStorePassword[] = HTML_QuickForm2::createElement('radio', 'ldap_store_password', null, _("Yes"), '1');
$ldapStorePassword[] = HTML_QuickForm2::createElement('radio', 'ldap_store_password', null, _("No"), '0');
$form->addGroup($ldapStorePassword, 'ldap_store_password', _("Store LDAP password"), '&nbsp;');

$ldapAutoImport[] = HTML_QuickForm2::createElement('radio', 'ldap_auto_import', null, _("Yes"), '1');
$ldapAutoImport[] = HTML_QuickForm2::createElement('radio', 'ldap_auto_import', null, _("No"), '0');
$form->addGroup($ldapAutoImport, 'ldap_auto_import', _("Auto import users"), '&nbsp;');

$ldapUseDns[] = HTML_QuickForm2::createElement(
    'radio',
    'ldap_srv_dns',
    null,
    _("Yes"),
...
$ldapDnsUseSsl[] = HTML_QuickForm2::createElement('radio', 'ldap_dns_use_ssl', null, _("Yes"), '1');
$ldapDnsUseSsl[] = HTML_QuickForm2::createElement('radio', 'ldap_dns_use_ssl', null, _("No"), '0');
$form->addGroup($ldapDnsUseSsl, 'ldap_dns_use_ssl', _("Use SSL connection"), '&nbsp;');
$ldapDnsUseTls[] = HTML_QuickForm2::createElement('radio', 'ldap_dns_use_tls', null, _("Yes"), '1');
$ldapDnsUseTls[] = HTML_QuickForm2::createElement('radio', 'ldap_dns_use_tls', null, _("No"), '0');
