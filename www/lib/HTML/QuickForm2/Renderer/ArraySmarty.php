...
/**
 * A static renderer for HTML_QuickForm2, makes an array of form content
...
/**
 * A concrete renderer for HTML_QuickForm2, makes an array of form contents
 */
 ...
 * useful for a Smarty template
 *
 * Based on old HTML_QuickForm2::toArray() code and ITStatic renderer.
 *
 ...
 * @since       3.0
 */
class HTML_QuickForm2_Renderer_ArraySmarty extends HTML_QuickForm2_Renderer_Array
{
   /**#@+
    * @access private
    */
    ...
    * @access public
    */
    function HTML_QuickForm2_Renderer_ArraySmarty(&$tpl, $staticLabels = false, $collectHidden = true)
    {
    ...
    *
    * @param    HTML_QuickForm2_header   header element being visited
    * @access   public
    * @return   void
    */
    ...
    *
    * @param    HTML_QuickForm2_group    group being visited
    * @param    bool                    Whether a group is required
    * @param    string                  An error message associated with a group
    * @access   public
    * @return   void
    */
    function startGroup(\HTML_QuickForm2_Node $group)
    {
    ...
    *
    * @access private
    * @param  HTML_QuickForm2_element    form element being visited
