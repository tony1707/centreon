 ...
 */
class HTML_QuickForm2_Element_Select2 extends HTML_QuickForm2_Element_Select
{
    /**
     *
     * @var string
     ...
     * @param string $sort
     */
    public function HTML_QuickForm2_select2(
        $elementName = null,
        $elementLabel = null,
        $options = null,
        $attributes = null,
        ...
        $this->HTML_QuickForm2_select($elementName, $elementLabel, $options, $attributes);
     ...
     * @return boolean
     */
    public function onQuickForm2Event($event, $arg, &$caller)
    {
        if ('updateValue' == $event) {
            ...
            if (null === $value) {
                ...
                // XXX: should we push this to element::onQuickForm2Event()?
            ...
            return parent::onQuickForm2Event($event, $arg, $caller);
        }
    }
}
